...
export const id = {
  ...
  planning: {
    ...
    stepTargets: "Pilih tugas hari ini",
    stepTargetsHint:
      "Centang tugas yang mau kamu kerjakan hari ini. Boleh tambah tugas baru di sini.",
    ...
    doneTitle: "Rencana hari ini siap",
    doneSubtitle: (n: number) => `${n} agenda terjadwal.`,
    close: "Tutup",
  },

  today: {
    title: "Hari Ini",
    planSection: "Rencana hari ini",
    planEmpty: "Belum ada agenda hari ini. Pilih tugas di bawah, lalu alokasikan.",
    candidateSection: "Kandidat",
    candidateEmpty: "Tidak ada tugas yang menunggu dijadwalkan.",
    capacity: (used: number, total: number) =>
      `Terpakai ${used} / kapasitas ${total} pomodoro`,
    capacityOver: "Melebihi kapasitas hari ini.",
    allocate: "Alokasikan otomatis",
    allocateSelected: (n: number) => `Alokasikan ${n} tugas`,
    allocating: "Menghitung…",
    ...
    unfitTitle: (n: number) => `Tidak muat hari ini (${n} todo)`,
    unfitHint:
      "Coba: perpanjang jam produktif · kurangi target hari ini · turunkan estimasi",
    nothingToAllocate: "Tidak ada todo yang perlu dialokasikan.",
    selectTodo: "Pilih tugas ini",
    deselectTodo: "Lepas tugas ini",
    plan: "Rencanakan hari",
  },
